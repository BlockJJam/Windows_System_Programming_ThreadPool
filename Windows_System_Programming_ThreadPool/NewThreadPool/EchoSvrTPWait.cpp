...
void WINAPI Handler_ScokChild(PTP_CALLBACK_INSTANCE, PVOID pCtx, PTP_WAIT pWait, TP_WAIT_RESULT)
{
...
void  WINAPI Handler_SockListen(PTP_CALLBACK_INSTANCE, PVOID pCtx, PTP_WAIT pWait, TP_WAIT_RESULT)
{
	...
	try
	{
		...
		PTP_WAIT psoWait = CreateThreadpoolWait(Handler_ScokChild, pci, NULL);
